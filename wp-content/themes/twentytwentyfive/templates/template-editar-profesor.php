...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($nombreProfesor === null || $apellidosProfesor === null || $emailProfesor === null || $usuarioProfesor === null || $rolProfesor === null) {
...
<main>
    ...
    <div class="form-field">
        ...
        <input class="form-input" type="password" name="password-editar-profesor" id="password-profesor" placeholder="Mínimo 8 caracteres" required />
    </div>
